...
export const metadata: Metadata = {
  ...
  description:
    "Professional roofing services including installation, repair, and maintenance for all roof types.",
};
...
export default function RoofingPage() {
  const galleryImages = [
    ...
    "/images/roofing/8.jpg",
    "/images/roofing/9.jpg",
    "/images/roofing/10.jpg",
    "/images/roofing/11.jpg",
    "/images/roofing/12.jpg",
    "/images/roofing/13.jpg",
    "/images/roofing/14.jpg",
    "/images/roofing/15.jpg",
    "/images/roofing/16.jpg",
    "/images/roofing/17.jpg",
    "/images/roofing/18.jpg",
    "/images/roofing/19.jpg",
    "/images/roofing/20.jpg",
  ];
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                ...
                roofing services for both residential and commercial properties.
                Our experienced team specializes in all aspects of roofing, from
                new installations to repairs and maintenance.
              </p>
              <p className="text-gray-600 dark:text-gray-300 mb-6">
                We work with a variety of roofing materials including asphalt
                shingles, metal roofing, tile, slate, and flat roofing systems.
                Our commitment to quality craftsmanship and customer
                satisfaction has made us a trusted name in the roofing industry.
              </p>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              We provide a wide range of roofing services to meet all your
              needs, from minor repairs to complete roof replacements.
            </p>
          </div>
              ...
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Complete roof installation services for new construction or
                    full replacements, using quality materials and expert
                    craftsmanship.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Professional repair services for damaged roofs, including
                    leak repairs, shingle replacement, and storm damage
                    restoration.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Regular maintenance programs to extend the life of your
                    roof, including inspections, cleaning, and preventative
                    repairs.
                  </p>
                </div>
              </CardContent>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    24/7 emergency roof repair services for storm damage, leaks,
                    and other urgent roofing issues.
                  </p>
                </div>
              </CardContent>
            </Card>
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Comprehensive roof inspections to identify potential issues
            ...
            <Card>
              <CardContent className="p-6">
                <div className="flex flex-col items-center text-center">
                  ...
                  <p className="text-gray-600 dark:text-gray-300">
                    Installation and repair of gutters and downspouts to protect
                    your roof and foundation from water damage.
                  </p>
                </div>
              </CardContent>
            </Card>
      ...
      <section className="py-12 bg-white dark:bg-gray-900">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              We offer a variety of high-quality roofing materials to suit your
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Long-lasting, energy-efficient, and environmentally friendly.
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Elegant and durable, perfect for Mediterranean, Spanish, or
                mission-style homes. Available in clay or concrete.
              </p>
              <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-md overflow-hidden relative">
                <Image
                  src="/images/roofing/Tile Roofing.png"
                  alt="Tile Roofing"
                  fill
                  className="object-cover"
                />
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Premium, natural stone roofing that offers unmatched beauty and
                longevity. Perfect for luxury homes.
              </p>
              <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-md overflow-hidden relative">
                <Image
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Specialized systems for flat or low-slope roofs, including EPDM,
                TPO, and modified bitumen.
              </p>
              <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-md overflow-hidden relative">
                <Image
                  src="/images/roofing/Flat Roofing.png"
                  alt="Flat Roofing"
                  fill
                  className="object-cover"
                />
            ...
            <div className="bg-gray-50 dark:bg-gray-800 p-6 rounded-lg">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-4">
                Natural wood shingles that provide a rustic, distinctive look
                with excellent insulation properties.
              </p>
              <div className="aspect-video bg-gray-200 dark:bg-gray-700 rounded-md overflow-hidden relative">
                <Image
                  src="/images/roofing/Cedar Shakes.png"
                  alt="Cedar Shakes"
                  fill
                  className="object-cover"
                />
      ...
      <section className="py-12 bg-gray-50 dark:bg-gray-800">
        <div className="container mx-auto px-4">
          <div className="text-center mb-12">
            ...
            <p className="text-gray-600 dark:text-gray-300 max-w-2xl mx-auto">
              Browse through some of our recent roofing projects to see the
      ...
      <section className="py-12 bg-red-700 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="max-w-2xl mx-auto mb-8">
            ...
            ready to help you with all your roofing needs.
          </p>
